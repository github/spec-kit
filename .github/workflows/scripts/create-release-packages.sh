...
#     AGENTS  : space or comma separated subset of: claude gemini copilot cursor qwen opencode windsurf codex kilocode auggie roocode (default: all)
...
build_variant() {
  ...
  case $agent in
    ...
    roocode)
      ...
      generate_commands roocode md "\$ARGUMENTS" "$base_dir/.roo/commands" "$script" ;;
  esac
