...
| Spec Impact | Blast radius analysis for spec changes — show what breaks before you change a requirement | `process` | Read-only | [spec-kit-impact-](https://github.com/Quratulain-bilal/spec-kit-impact-) |
