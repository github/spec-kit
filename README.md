...
| `check`     | Check for installed tools (`git`, `claude`, `gemini`, `iflow`, `code`/`code-insiders`, `cursor-agent`) |
...
| `--ai`                 | Option   | AI assistant to use: `claude`, `gemini`, `copilot`, `cursor`, or `iflow`    |
...
- AI coding agent: [Claude Code](https://www.anthropic.com/claude-code), [GitHub Copilot](https://code.visualstudio.com/), [Gemini CLI](https://github.com/google-gemini/gemini-cli), [Cursor](https://cursor.sh/), or [iFlow CLI](https://github.com/iflow-ai/iflow-cli)
...
The CLI will check if you have Claude Code, Gemini CLI, or iFlow CLI installed. If you do not, or you prefer to get the templates without checking for the right tools, use `--ignore-agent-tools` with your command:
