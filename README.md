...
| Security Review | Full-project secure-by-design security audits plus staged, branch/PR, plan, task, and follow-up reviews | `code` | Read-only | [spec-kit-security-review](https://github.com/DyanGalih/spec-kit-security-review) |
