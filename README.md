...
| [Pi Coding Agent](https://pi.dev)                                                    | ✅      | Pi doesn't have  MCP support OOTB so `taskstoissues` will not work as intended. MCP support can be added via [extensions](https://github.com/badlogic/pi-mono/tree/main/packages/coding-agent#extensions)|
