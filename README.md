...
Use the `/specify` command in github copilot with the project folder open in VSCode to describe what you want to build. Focus on the **what** and **why**, not the tech stack.
