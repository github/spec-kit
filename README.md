...
| TEKIMAX Secure SDD | Security gates for AI-driven SDD — threat modeling (STRIDE), automated red teaming, guardrails, data contracts, model governance | `security` | Read+Write | [speckit-security](https://github.com/TEKIMAX/speckit-security) |
