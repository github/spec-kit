...
| `--script`             | Option   | Script variant to use: `sh` (bash/zsh), `ps` (PowerShell), or `fish` (fish shell) |
...
# Initialize with fish shell scripts
specify init my-project --ai copilot --script fish
