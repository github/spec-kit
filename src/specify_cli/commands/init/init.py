...
def init_command(
    ...
    try:
        ...
        if result:
            ...
            steps_lines.append(f"{step_num}. Update [bold magenta]CONSTITUTION.md[/bold magenta] with your project's principles")
            steps_lines.append(f"{step_num + 1}. Use your AI assistant to start developing!")
