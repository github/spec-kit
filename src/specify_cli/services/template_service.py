...
class JinjaTemplateService(TemplateService):
    ...
    def render_template(self, template_name: str, context: TemplateContext) -> str:
        ...
        if self._environment is None:
            raise RuntimeError("No template package loaded. Call load_template_package first.")
    ...
    def _prepare_context(self, context: TemplateContext) -> dict:
        ...
        if hasattr(context, 'to_dict'):
            ...
            for attr in ['project_name', 'ai_assistant', 'feature_name', 'branch_type', 
                       'author', 'version', 'branch_name', 'task_name', 'author_name',
                       'author_email', 'creation_date', 'creation_year', 'project_description']:
    ...
    def _regex_replace_filter(self, value: str, pattern: str, replacement: str = "") -> str:
