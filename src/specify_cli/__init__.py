...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor, qwen, opencode, codex, windsurf, kilocode, auggie, or roocode"),
...
def check():
    ...
    tracker.add("roocode", "Roo Code CLI")
    ...
    roocode_ok = check_tool_for_tracker("roocode", tracker)
    ...
    if not (claude_ok or gemini_ok or cursor_ok or qwen_ok or windsurf_ok or kilocode_ok or opencode_ok or codex_ok or auggie_ok or roocode_ok):
