...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor, qwen, opencode, codex, windsurf, kilocode, auggie, or droid"),
    ...
    2. Let you choose your AI assistant (Claude Code, Gemini CLI, GitHub Copilot, Cursor, Qwen Code, opencode, Codex CLI, Windsurf, Kilo Code, Auggie CLI, or Factory CLI)
    ...
    if not ignore_agent_tools:
        ...
        if selected_ai == "claude":
            ...
            if not check_tool("droid", "https://docs.factory.ai/cli/getting-started/quickstart"):
...
def check():
    ...
    droid_ok = check_tool_for_tracker("droid", tracker)
    ...
    if not (claude_ok or gemini_ok or cursor_ok or qwen_ok or windsurf_ok or kilocode_ok or opencode_ok or codex_ok or auggie_ok or droid_ok):
