...
def init(
    ...
    ai_assistant: str = typer.Option(
        None,
        "--ai",
        help="AI assistant to use: claude, gemini, copilot, cursor, qwen, opencode, codex, or windsurf",
    ),
    ...
    if not ignore_agent_tools:
        ...
        if selected_ai == "claude":
            ...
            if not check_tool(
                "qwen", "Install from: https://github.com/QwenLM/qwen-code"
            ):
                console.print(
                    "[red]Error:[/red] Qwen CLI is required for Qwen Code projects"
                )
                agent_tool_missing = True
        elif selected_ai == "opencode":
            if not check_tool("opencode", "Install from: https://opencode.ai"):
                console.print(
                    "[red]Error:[/red] opencode CLI is required for opencode projects"
                )
                agent_tool_missing = True
        elif selected_ai == "codex":
            if not check_tool("codex", "Install from: https://github.com/openai/codex"):
                console.print(
                    "[red]Error:[/red] Codex CLI is required for Codex projects"
                )
                agent_tool_missing = True
...
def check():
    ...
    qwen_ok = check_tool_for_tracker(
        "qwen", "https://github.com/QwenLM/qwen-code", tracker
    )
    ...
    codex_ok = check_tool_for_tracker(
        "codex", "https://github.com/openai/codex", tracker
    )
