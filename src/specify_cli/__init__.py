...
SCRIPT_TYPE_CHOICES = {"sh": "POSIX Shell (bash/zsh)", "ps": "PowerShell", "fish": "Fish Shell"}
...
def init(
    ...
    ai_assistant: str = typer.Option(
        None,
        "--ai",
        help="AI assistant to use: claude, gemini, copilot, cursor, qwen, opencode, codex, windsurf, kilocode, or auggie",
    ),
    script_type: str = typer.Option(None, "--script", help="Script type to use: sh, ps, or fish"),
...
For more information, see: [cyan]https://github.com/openai/codex/issues/2890[/cyan]"""
        ...
        warning_panel = Panel(
            warning_text, title="Slash Commands in Codex", border_style="yellow", padding=(1, 2)
        )
        console.print()
...
def check():
    ...
    check_tool_for_tracker("code", tracker)
    check_tool_for_tracker("code-insiders", tracker)
