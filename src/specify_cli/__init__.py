...
AGENT_CONFIG = {
    ...
    "hoosh": {
        "name": "Hoosh",
        "folder": ".hoosh/",
        "install_url": "https://nomad-prime.github.io/hoosh-docs/",
        "requires_cli": True,
    },
}
...
def init(
    ...
    ai_assistant: str = typer.Option(None, "--ai", help="AI assistant to use: claude, gemini, copilot, cursor-agent, qwen, opencode, codex, windsurf, kilocode, auggie, codebuddy, amp, shai, q, agy, bob, hoosh, or qoder "),
