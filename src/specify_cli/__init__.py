...
from .agent_config import AGENT_CONFIG, AI_ASSISTANT_ALIASES
...
# Agent configuration and aliases are shared with command registration logic.
# Keep this module-level import assignment so existing imports/tests remain stable.

# Agents that use TOML command format (others use Markdown).
# Kept for compatibility with tests and scaffolding helpers.
