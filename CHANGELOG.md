...
- **Removed legacy `--ai`, `--ai-commands-dir`, and `--ai-skills` flags from `specify init`.**
  Use `--integration <name>`, `--integration-options="--commands-dir <dir>"`, and
  `--integration-options="--skills"` respectively.
