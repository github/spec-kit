...
| Spec Kit Discovery Extension | Technical discovery before formal planning: feasibility, technology selection, codebase risk, implementation understanding, PoC validation, and scenario-specific decisions | `process` | Read+Write | [spec-kit-discovery](https://github.com/bigsmartben/spec-kit-discovery) |
