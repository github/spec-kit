...
| Superpowers Bridge | Bridges selected installed quality-control skills into Spec Kit workflows and adds bridge-native utilities. | `process` | Read+Write | [superpowers-bridge](https://github.com/RbBtSn0w/spec-kit-extensions/tree/main/superpowers-bridge) |
