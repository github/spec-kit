...
| Multi-Sites Spec Kit | Adds a multi-site-aware /speckit.specify workflow with per-site spec folders, independent auto-increment counters, and Drupal layout support | `process` | Read+Write | [spec-kit-multi-sites](https://github.com/teeyo/spec-kit-multi-sites) |
