...
```bash
uvx --from git+https://github.com/github/diagramly-kit.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/github/diagramly-kit.git specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
...
Use `/diagramlykit.tasks` to create an actionable task list, then ask your agent to implement the feature.

## Detailed Example: Building Taskify

Here's a complete example of building a team productivity platform:

### Step 1: Define Requirements with `/diagramlykit.specify`
...
### Step 3: Generate Technical Plan with `/diagramlykit.plan`
