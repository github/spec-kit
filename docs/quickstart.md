...
```bash
uvx --from git+https://github.com/ykg3211/x-spec-kit.git specify init <PROJECT_NAME> --script ps  # Force PowerShell
uvx --from git+https://github.com/ykg3211/x-spec-kit.git specify init <PROJECT_NAME> --script sh  # Force POSIX shell
```
