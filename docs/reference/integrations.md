...
| [MySpec](https://myspec.dev)                                                | `myspec`         | AI-native Spec-Driven Development platform generating standardized 4-file spec bundles (`constitution.md`, `requirements.md`, `solution.md`, `tasks.md`) with built-in MCP server support for Cursor and Claude. *(Free tier available)* |
