...
6. **(depends on ...)**: Append at end if the task depends on specific other task IDs. Omit if the task has no dependencies within its phase. Use comma-separated IDs for multiple dependencies.
