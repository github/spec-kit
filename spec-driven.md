...
### The `/diagramlykit.specify` Command
...
### The `/diagramlykit.tasks` Command
...
/diagramlykit.specify Real-time chat system with message history and user presence
...
/diagramlykit.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
...
```text
Every feature in Diagramly MUST begin its existence as a standalone library.
