...
| DocGuard — CDD Enforcement | Canonical-Driven Development enforcement. Generates, validates, scores, and traces project documentation with comprehensive automated checks, AI behavior protocols, and workflow hooks. Zero dependencies. | [spec-kit-docguard](https://github.com/raccioly/docguard) |
