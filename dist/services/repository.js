...
class RepositoryService {
    ...
    async isRepositorySeeded(projectId) {
        try {
    ...
    async seedRepository(projectId, targetRepo) {
        try {
            ...
            // Create pull request
            const prUrl = await this.createPullRequest(repoId, branchName, 'main', 'Add Spec Kit Configuration', 'This PR adds Spec Kit configuration files and prompt templates to enable AI-powered specification workflows.');
            return {
                success: true,
                prUrl,
                branchName,
    ...
    async getPromptTemplate(filePath) {
        const templates = {
...
- Scalability: Support 10,000 concurrent users`
    ...
    async getConfigTemplate(filePath) {
        const templates = {
