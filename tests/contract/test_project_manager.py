...
from specify_cli.models.project import ProjectInitOptions, ProjectInitResult, ProjectInitStep
...
class TestProjectManagerContract:
    ...
    def test_initialize_project_contract(self, project_manager: ProjectManager, basic_init_options: ProjectInitOptions, tmp_path: Path):
    ...
    def test_initialize_project_current_dir_contract(self, project_manager: ProjectManager, current_dir_options: ProjectInitOptions, tmp_path: Path):
    ...
    def test_validate_project_directory_contract(self, project_manager: ProjectManager, tmp_path: Path):
        ...
        is_valid, error = project_manager.validate_project_directory(non_empty_dir, False)
        assert isinstance(is_valid, bool)
        assert error is None or isinstance(error, str)
        ...
        is_valid, error = project_manager.validate_project_directory(tmp_path / "nonexistent", False)
        assert isinstance(is_valid, bool)
        assert error is None or isinstance(error, str)

    def test_setup_project_structure_contract(self, project_manager: ProjectManager, tmp_path: Path):
    ...
    def test_configure_branch_naming_contract(self, project_manager: ProjectManager, tmp_path: Path):
    ...
    def test_migrate_existing_project_contract(self, project_manager: ProjectManager, tmp_path: Path):
    ...
    def test_get_project_info_contract(self, project_manager: ProjectManager, tmp_path: Path):
    ...
    def test_cleanup_failed_init_contract(self, project_manager: ProjectManager, tmp_path: Path):
...
class TestProjectManagerIntegration:
    ...
    def test_full_project_initialization_workflow(self, project_manager: ProjectManager, tmp_path: Path):
        ...
        try:
            ...
            is_valid, error = project_manager.validate_project_directory(project_path, False)
            if not is_valid:
    ...
    def test_current_directory_initialization_workflow(self, project_manager: ProjectManager, tmp_path: Path):
    ...
    def test_project_validation_edge_cases(self, project_manager: ProjectManager, tmp_path: Path):
