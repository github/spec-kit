...
class TestTemplateServiceContract:
    ...
    def test_load_template_package_contract(self, template_service: TemplateService, temp_template_dir: Path):
        ...
        result = template_service.load_template_package("claude", temp_template_dir / "nonexistent")
        assert isinstance(result, bool)
        assert result is False

    def test_render_template_contract(self, template_service: TemplateService, sample_context: TemplateContext, temp_template_dir: Path):
    ...
    def test_render_project_templates_contract(self, template_service: TemplateService, sample_context: TemplateContext, temp_template_dir: Path, tmp_path: Path):
    ...
    def test_validate_template_syntax_contract(self, template_service: TemplateService, temp_template_dir: Path):
        ...
        # Test non-existent template
        is_valid, error = template_service.validate_template_syntax(temp_template_dir / "nonexistent.j2")
        assert isinstance(is_valid, bool)
        assert is_valid is False
        assert isinstance(error, str)

    def test_get_template_variables_contract(self, template_service: TemplateService, temp_template_dir: Path):
    ...
    def test_set_custom_template_dir_contract(self, template_service: TemplateService, temp_template_dir: Path):
        ...
        result = template_service.set_custom_template_dir(temp_template_dir / "nonexistent")
        assert isinstance(result, bool)
        assert result is False
...
class TestTemplateServiceIntegration:
    ...
    def test_full_template_workflow(self, template_service: TemplateService, tmp_path: Path):
