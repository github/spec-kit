...
class TestConfigServiceContract:
    ...
    def sample_project_config(self) -> ProjectConfig:
        ...
        return ProjectConfig(
            ...
            branch_naming=BranchNamingConfig(
                ...
                patterns=["feature/{feature-name}", "bugfix/{bug-id}", "hotfix/{version}", "epic/{epic-name}"]
            ),
    ...
    @pytest.fixture
    def project_with_config(self, tmp_path: Path, sample_project_config: ProjectConfig) -> Path:
...
"""
    ...
    def test_load_project_config_contract(self, config_service: ConfigService, project_with_config: Path):
    ...
    def test_save_project_config_contract(self, config_service: ConfigService, sample_project_config: ProjectConfig, tmp_path: Path):
        ...
        result = config_service.save_project_config(Path("/invalid/path"), sample_project_config)
        assert isinstance(result, bool)
        assert result is False

    def test_load_global_config_contract(self, config_service: ConfigService, monkeypatch):
...
""")
    ...
    def test_save_global_config_contract(self, config_service: ConfigService, sample_project_config: ProjectConfig, monkeypatch):
    ...
    def test_get_merged_config_contract(self, config_service: ConfigService, project_with_config: Path):
    ...
    def test_backup_config_contract(self, config_service: ConfigService, project_with_config: Path):
    ...
    def test_restore_config_contract(self, config_service: ConfigService, project_with_config: Path):
