...
class TestExtensionCatalog:
    ...
    def test_make_request_auth_attached_for_any_url_when_configured(self, temp_dir, monkeypatch):
    ...
    def test_make_request_no_auth_when_unconfigured(self, temp_dir, monkeypatch):
