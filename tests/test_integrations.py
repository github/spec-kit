...
class TestInitIntegrationFlag:
    ...
    def test_complete_file_inventory_ps(self, tmp_path):
        """Every file produced by --integration copilot --script ps is accounted for."""
        from typer.testing import CliRunner
        from specify_cli import app

        project = tmp_path / "inventory-ps-test"
        project.mkdir()
        import os
        old_cwd = os.getcwd()
        try:
