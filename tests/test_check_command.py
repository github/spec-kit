...
class TestCheckCommand:
    ...
    def test_check_command_runs_successfully(self):
        ...
        with patch("infrakit_cli.check_tool") as mock_check:
    ...
    def test_check_command_shows_summary(self):
        ...
        with patch("infrakit_cli.check_tool", return_value=True):
            result = runner.invoke(app, ["check"])
    ...
    @patch("infrakit_cli.check_tool")
    @patch("infrakit_cli.is_git_repo")
