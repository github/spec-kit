...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/infrakit-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/infrakit-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/infrakit-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/infrakit-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/infrakit-rules.md"
CODEBUDDY_FILE="$REPO_ROOT/CODEBUDDY.md"
QODER_FILE="$REPO_ROOT/QODER.md"
AMP_FILE="$REPO_ROOT/AGENTS.md"
SHAI_FILE="$REPO_ROOT/SHAI.md"
Q_FILE="$REPO_ROOT/AGENTS.md"
AGY_FILE="$REPO_ROOT/.agent/rules/infrakit-rules.md"
BOB_FILE="$REPO_ROOT/AGENTS.md"

# Template file
TEMPLATE_FILE="$REPO_ROOT/.infrakit/templates/agent-file-template.md"
...
validate_environment() {
    ...
    if [[ -z "$CURRENT_BRANCH" ]]; then
        ...
        if [[ "$HAS_GIT" == "true" ]]; then
            ...
            log_info "Set INFRAKIT_RESOURCE environment variable or create a feature first"
        fi
        exit 1
    fi
    ...
    if [[ ! -f "$NEW_PLAN" ]]; then
        ...
        if [[ "$HAS_GIT" != "true" ]]; then
            log_info "Use: export INFRAKIT_RESOURCE=your-feature-name or create a new feature first"
        fi
        exit 1
    fi
