...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/spectrena-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/spectrena-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/spectrena-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/spectrena-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/spectrena-rules.md"
...
# Template file
TEMPLATE_FILE="$REPO_ROOT/.spectrena/templates/agent-file-template.md"
