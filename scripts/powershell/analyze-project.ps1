...
$analysisReportPath = Join-Path $Output "analysis-report.md"
$analysisTemplate | Out-File -FilePath $analysisReportPath -Encoding utf8

Write-Host "✓ Created analysis workspace" -ForegroundColor Green
Write-Host "ℹ File: $analysisReportPath (template)" -ForegroundColor Blue
Write-Host ""
