...
Mirrors the behavior of scripts/bash/update-agent-context.sh:
 ...
 5. Multi-Agent Support (claude, gemini, copilot, cursor, qwen, opencode, codex, windsurf, kilocode, auggie, roo, codebuddy, q)
...
function Update-SpecificAgent {
    ...
    switch ($Type) {
        ...
        'codebuddy' { Update-AgentFile -TargetFile $CODEBUDDY_FILE -AgentName 'CodeBuddy Code' }
...
function Update-AllExistingAgents {
    ...
    if (Test-Path $CODEBUDDY_FILE) { if (-not (Update-AgentFile -TargetFile $CODEBUDDY_FILE -AgentName 'CodeBuddy Code')) { $ok = $false }; $found = $true }
