...
## AI contributions in SpecLite

> [!IMPORTANT]
>
> If you are using **any kind of AI assistance** to contribute to SpecLite,
> it must be disclosed in the pull request or issue.

We welcome and encourage the use of AI tools to help improve SpecLite! Many valuable contributions have been enhanced with AI assistance for code generation, issue detection, and feature definition.

That being said, if you are using any kind of AI assistance (e.g., agents, ChatGPT) while contributing to SpecLite,
...
- **Clear rationale** - You can explain why the change is needed and how it fits within SpecLite's goals
