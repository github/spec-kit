...
| Platform | Mapping |
| --- | --- |
| Codex | Core Agent, Vertical Planner Agent, Worker Agent |
| Claude Code | core, planner, worker |
| Gemini CLI | `speckit_core`, `speckit_planner`, `speckit_worker` |
| GitHub Copilot | coordinator, planner, worker |
